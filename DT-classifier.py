...
#the following code is for Decision Tree Classifier with k-fold cv for 100 different seed values and reports the average rmse along with standard deviation
...
num_estimators_values = np.arange(1000,11000,1000) 
...
def kfoldcv(seed,numest):
    ...
    for i in np.arange(len(splitpoints)):
        ...
        clf = DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=num_estimators_arg, min_samples_split=2,                                                       min_samples_leaf=1,min_weight_fraction_leaf=0.0, max_features=None, random_state=None,                                                     max_leaf_nodes=None, min_impurity_decrease=0.0, min_impurity_split=None, class_weight=None)
...
def compute_testscore(seed,best_numest):
    ...
    final_clf = DecisionTreeClassifier(criterion='gini', splitter='best', max_depth=final_best_estimator, min_samples_split=2,                                                     min_samples_leaf=1, min_weight_fraction_leaf=0.0, max_features=None, random_state=None,                                                     max_leaf_nodes=int(math.sqrt(len(final_train_feat[0]))),                                                                                   min_impurity_decrease=0.0, min_impurity_split=None, class_weight=None, presort=False)
