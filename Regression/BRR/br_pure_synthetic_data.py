...
def kfoldcv(seed,numest,alphav):
    ...
    for i in np.arange(len(splitpoints)):
        ...
        regr = BayesianRidge(n_iter=300, tol=0.001, alpha_1=C_val, alpha_2=alpha_val_arg, lambda_1=1e-06, lambda_2=1e-06, 
...
def compute_testrmse(seed,best_C_val, best_alpha_val):
    ...
    final_regr = BayesianRidge(n_iter=300, tol=0.001, alpha_1=best_C_val, alpha_2=best_alpha_val, lambda_1=1e-06, lambda_2=1e-06, 
                             compute_score=False, fit_intercept=True, normalize=False, copy_X=True, verbose=False)
