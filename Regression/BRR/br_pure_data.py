...
#the following code is for Bayesian ridge regression with k-fold cv for 100 different seed values and reports the average rmse along with standard deviation
...
C_values = [1E-6,1E-5, 1E-4, 1E-3, 0.01, 0.1, 0.5, 0.9] #, 0.5, 0.7] #[0.00001, 0.0001, 0.001, 0.01, 0.1, 1] 

alpha_values = [1E-6,1E-5, 1E-4, 1E-3, 0.01, 0.1, 0.5, 0.9]
seed_numest_pair = []
...
def kfoldcv(seed,numest,alphav):
    ...
    for i in np.arange(len(splitpoints)):
        ...
        regr = BayesianRidge(n_iter=300, tol=0.001, alpha_1=1e-06, alpha_2=1e-06, lambda_1=C_val_arg, lambda_2=alpha_val_arg, 
...
def compute_testrmse(seed,best_C_val, best_alpha_val):
    ...
    final_regr = BayesianRidge(n_iter=300, tol=0.001, alpha_1=1e-06, alpha_2=1e-06, lambda_1=final_best_C_val, lambda_2=final_best_alpha_val, 
                             compute_score=False, fit_intercept=True, normalize=False, copy_X=True, verbose=False)
